...
use App\Modules\Core\Setting\Drivers\Database;
use App\Modules\Core\Setting\Drivers\Json;
use App\Modules\Core\Setting\Drivers\Memory;
...
class SettingManager extends BaseManager
{
	 ...
	 */
	public function __construct($app = null, $module)
	{
        if (!$app) {
